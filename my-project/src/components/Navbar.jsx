    ...
    return (
      <nav className="flex flex-row items-center justify-between bg-slate-900 text-white py-4 px-6">
        ...
        <div className="hidden lg:flex md:flex lg:flex-1 items-center justify-end font-normal space-x-6">
          ...
          <Link to="/Profile" spy={true} smooth={true} className="hover:bg-slate-800 hover:rounded py-2 px-4 hover:scale-110 ease-in duration-200">
            <AiOutlineUser size={20} /> Profile
          </Link>
          
          <Link to="/Psych" spy={true} smooth={true} className="hover:bg-slate-800 hover:rounded py-2 px-4 hover:scale-110 ease-in duration-200">
